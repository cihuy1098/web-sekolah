...
<head>
    ...
    <title>
        Profile Sekolah - {{ $profile->nama_sekolah ?? 'MTs YAPPENA' }}
    </title>
...
<body
            ...
            <ul class="flex flex-col pl-0 mb-0">
                ...
                <li class="mt-0.5 w-full">
                    ...
                    <a href="#"
                        ...
                        <div
                            class="mr-2 flex h-8 w-8 items-center
                ...
                <li class="mt-0.5 w-full">
                    ...
                    <a href="#"
                        ...
                        <div
                            ...
                            <i class="fas fa-user-plus text-slate-800 text-xs"></i>
    ...
    <div
        ...
        <div class="w-full px-6 mx-auto pt-20">
            ...
            <div
                class="relative flex flex-col min-w-0 p-4 mx-6 -mt-16
                ...
                <div class="flex items-center">
                    ...
                    <div
                        ...
                        <img
                            src="{{ isset($profile->logo)
                                ? asset('storage/' . $profile->logo)
                                : asset('img/bruce-mars.jpg') }}"
                            alt="Logo Sekolah"
                            style="
                                width:100%;
                                height:100%;
                    ...
                    <div class="ml-5">
                        ...
                        <h5
                            class="mb-1 font-bold text-slate-700 text-xl">
        ...
        <div class="w-full px-6 mx-auto mt-6">
            ...
            <div class="flex flex-wrap -mx-3">
                ...
                <div class="w-full px-3 lg:w-8/12">
                    ...
                    <div
                        class="relative flex flex-col h-full min-w-0
                        ...
                        <div
                            ...
                            <h6
                                class="font-bold text-slate-700 mb-0">
                ...
                <div
                    class="w-full px-3 mt-6 lg:w-4/12 lg:mt-0">
                    ...
                    <div
                        ...
                        <h6
                            class="font-bold text-slate-700 pb-4
            ...
            <form
                ...
                <div class="mb-4">
                    ...
                    <textarea
                        ...
                        rows="4"
                        class="w-full mt-2 px-4 py-3 rounded-lg
                        border border-gray-300">{{ old('deskripsi', $profile->deskripsi ?? '') }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <textarea
                        ...
                        rows="6"
                        class="w-full mt-2 px-4 py-3 rounded-lg
                        border border-gray-300">{{ old('visi_misi', $profile->visi_misi ?? '') }}</textarea>
