                    ...
                    <div
                        ...
                        <div
                            ...
                            <ul
                                ...
                                <li>
                                    <a
                                        class="flex items-center px-4 py-2 mr-2 font-normal transition-all text-sm text-slate-700 lg:px-2"
                                        href="{{ url('/') }}">
                                ...
                                <li>
                                    <a
                                        class="block px-4 py-2 mr-2 font-normal transition-all text-sm text-slate-700 lg:px-2"
                                        href="#">
                ...
                <div class="container z-10">
                    ...
                    <div class="flex flex-wrap mt-0 -mx-3">
                        ...
                        <div
                            ...
                            <div
                                class="relative flex flex-col min-w-0 mt-32 break-words bg-transparent border-0 shadow-none rounded-2xl">
                                ...
                                <!-- Sign Up -->
                                <div
                                    class="p-6 px-1 pt-0 text-center bg-transparent border-t-0 rounded-b-2xl lg:px-2">
                        ...
                        <!-- Image -->
                        <div
                            class="w-full max-w-full px-3 lg:flex-0 shrink-0 md:w-6/12">
        ...
        <div class="container">
            ...
            <div class="flex flex-wrap -mx-3">
                ...
                <div
                    ...
                    <a href="#" class="mb-2 mr-4 text-slate-400">
                        Company
                    </a>
